...
\documentclass[9pt,compress,xcolor=x11names,UTF8]{beamer}
\usetheme{Boadilla}
...
% \setCJKsansfont[BoldFont={SimHei}, ItalicFont={KaiTi}, BoldItalicFont = {FangSong}]{SimSun}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{demo03} % 单图
\end{figure}
\end{frame}
...
\begin{frame}
\centering {\zihao{0} \color{green} \calligra{Thank You}}
